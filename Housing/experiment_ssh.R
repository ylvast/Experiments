...
source("/uio/hume/student-u69/ylvasto/privat/Experiments/Housing/config.R")
library(devtools)
...
train <- read.csv("/uio/hume/student-u69/ylvasto/privat/Experiments/Housing/train.csv")
test <- read.csv("/uio/hume/student-u69/ylvasto/privat/Experiments/Housing/test.csv")

# Result csv
now <-format(Sys.time(), "%Y-%m-%d_%H_%M")
Results <- paste("/uio/hume/student-u69/ylvasto/privat/Experiments/Housing/","results_",now,".csv", sep="")
testing_writing <- paste("/uio/hume/student-u69/ylvasto/privat/Experiments/Housing/","testing_",now,".csv", sep="")
write.csv(test, testing_writing, row.names = FALSE)
